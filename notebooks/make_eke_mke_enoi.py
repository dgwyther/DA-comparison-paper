...
filename = '/srv/scratch/z3533092/DA-comparison-paper/notebooks/enoi_'
ds = load_roms(filename='/srv/scratch/z3097808/forecasts_EnOI_TRADobs/output/eac_his_*.nc',overlap=19)
