...
enoi,enoi_bu = process_trimVarsROMS(enoi,['temp','z_rho0'])
_4dvar,_4dvar_bu = process_trimVarsROMS(_4dvar,['temp','z_rho0'])
...
enoi_34 = enoi.isel(eta_rho=115)

_4dvar_28 = _4dvar.isel(eta_rho=260)
_4dvar_34 = _4dvar.isel(eta_rho=115)

print('saving temp fields')

enoi_28.to_netcdf('../data/proc/enoi_28_temp.nc')
enoi_34.to_netcdf('../data/proc/enoi_34_temp.nc')

_4dvar_28.to_netcdf('../data/proc/4dvar_28_temp.nc')
_4dvar_34.to_netcdf('../data/proc/4dvar_34_temp.nc')